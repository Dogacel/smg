...
//! limit). The campaign entry point:
...
/// A present-but-malformed campaign variable is an operator error, never
/// a silent fall-through to the default (a `10_000` typo would otherwise
/// run the 1000-seed default and report success for a campaign nobody
/// asked for). Absent => default.
